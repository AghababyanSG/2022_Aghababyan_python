...
class Game:
    ...
    def mainloop(self):
        ...
        while not finished:
            ...
            self.screen.fill(self.bg)
            pygame.draw.line(self.screen, BLACK, (0, 9 * self.height // 10),
...
class Cannon:
    ...
    def draw(self, bg_color):
        ...
        pygame.draw.aalines(self.screen, GREY, False, tr)
...
class Ball:
    ...
    def draw(self):
        ...
        pygame.draw.circle(self.screen, BLACK, (self.x, self.y), self.size, 1)
...
class Emoji:
    ...
    def draw(self):
        ...
        pygame.draw.circle(self.screen, BLACK, left_eye, self.size // 4)
        pygame.draw.circle(self.screen, RED, left_eye, self.size // 10)

        right_eye = (self.x + self.size // 3, self.y - self.size // 3)
        pygame.draw.circle(self.screen, BLACK, right_eye, self.size // 4)
        pygame.draw.circle(self.screen, RED, right_eye, self.size // 10)

        mouth_rect = (self.x - self.size // 3, self.y + self.size // 4, 2 * self.size // 3, 2 * self.size // 3)
        pygame.draw.arc(self.screen, BLACK, mouth_rect, 0, math.pi, 3)

        pygame.draw.circle(self.screen, BLACK, (self.x, self.y), self.size, 2)
